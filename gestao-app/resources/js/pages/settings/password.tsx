        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        title="Alterar senha"
                        description="Mínimo de 12 caracteres. A senha é conferida contra vazamentos públicos conhecidos — só um trecho do código dela sai daqui, nunca a senha inteira."
                    />
